...
Lemma quiz7 (n: nat): ev n -> n=1 -> true = false.
Proof.
  intros  E F. destruct E as [|n E'] eqn:EE.
  - discriminate F.
  - discriminate F.
Qed.
...
Proof.
  intros n m H1 H2. induction H1 as [|n' H1' IH1'].
  - simpl. apply H2.
  - simpl. apply ev_SS. apply IH1'. Qed.
(** [] *)
...
Lemma plus_2: forall n, S(S n) = 2 + n.
Proof. 
...
Proof.
 split.
 - intros H. induction H as [H1 |  H2 | H3].
  * apply ev_0.
  * apply ev_SS. apply ev_0.
  * apply ev_sum. apply IHev'1. apply IHev'2.
- intros H. induction H as [| n' IH' IH2'].
  *  apply ev'_0.
   * rewrite plus_2. apply ev'_sum.
    --  apply ev'_2.
    -- apply IH2'.
Qed.
(** [] *)
...
Theorem ev_ev__ev : forall n m,
  ev (n+m) -> ev n -> ev m.
Proof.
  intros n m H1 H2. induction H2 as [| n' H2' IH2].
  - simpl in H1. apply H1.
  - generalize dependent H1. intros H3. apply ev_SS in IH2.
    ** inversion IH2. apply H0.
...
Proof.
  intros m n o H1 H2. inversion H1. 
  - apply H2.
...
Proof.
  ...
  - apply (MUnionL s _ _). apply H1.
  - apply (MUnionR _ s _). apply H2. Qed.
...
(** We can streamline this by defining an inductive proposition that
    ...
    Following the terminology introduced in [IndProp], we call
